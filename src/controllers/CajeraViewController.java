...
public class CajeraViewController implements Initializable {
    ...
    @FXML
    private Button btn_add_delivery;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btn_add_delivery.setOnAction(event -> agregarDelivery());
    ...
    private void agregarDelivery() {
        glassPaneD.setVisible(true);        
    }
    
    @FXML
    private void tomarDelivery() {
